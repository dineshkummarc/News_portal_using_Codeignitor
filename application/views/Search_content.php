...
<div class="card pt-4">
  ...
  <textarea class="form-control" rows="5" id="comment" name="message" style="resize:none;" placeholder="Enter your message here..." required></textarea>
  </div>
